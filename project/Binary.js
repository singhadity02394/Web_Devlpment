...
for (var i = 0; i < 20; i++) {
	...
	array_ele.classList.add("block1");
	...
	array_ele_label.classList.add("block1_id");
...
async function BinarySearch(delay = 300) {
	document.getElementById("Time_Worst2").innerText="O(logN)";
    document.getElementById("Time_Average2").innerText="O(logN)";
    document.getElementById("Time_Best2").innerText="O(1)";

	document.getElementById("Space_Worst2").innerText="O(1)";
